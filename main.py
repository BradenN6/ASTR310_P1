...
(master_bias, master_dark, master_flat_ha, master_flat_o, c_hLights, c_oLights, mul_h, mul_o) = \
...
addedFits,norm = dataReduce.stack(aligned,mul_h,1,1)
...
# addedFits,norm = dataReduce.stack(aligned,mul_o)
...
# addedFits,norm = dataReduce.stack(aligned,mul_h)
...
# dispFITS(H,0.5,0.3, "H-alpha image")
# dispFITS(O,0.5,0.3, "O[III] image")
